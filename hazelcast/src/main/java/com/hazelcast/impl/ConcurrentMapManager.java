...
//            System.out.println("map size " + mapRecords.size());
        ...
        public boolean putMulti(Request req) {
            ...
            if (added) {
                ...
                record.version++;
                touch(record);
                fireMapEvent(mapListeners, name, EntryEvent.TYPE_ADDED, record.key, d, record.mapListeners);
            }
